...
<head>
  ...
  <title>APLIKASIKU</title> <!-- Font Awesome Icons -->
  <link rel="stylesheet" href="<?php echo base_url() ?>asset/adminlte/plugins/fontawesome-free/css/all.min.css"> <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url() ?>asset/adminlte/dist/css/adminlte.min.css"> <!-- Google Font: Source Sans Pro -->
  ...
  <!----------------- JQUERY ------------------->
  <!-- jQuery -->
  <script src="<?php echo base_url() ?>asset/adminlte/plugins/jquery/jquery.min.js"></script> <!-- DataTables -->
