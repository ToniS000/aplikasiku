        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="<?php echo base_url() ?>data_mahasiswa/tambah" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Tambah data</a>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <form action="<?php echo base_url() . 'data_mahasiswa'; ?>" method="GET">
              <div class="row">
                <div class="col-md-3 col-sm-12">
                  <div class="form-group"> <?php $val_filter = $this->input->get('f_jeniskelamin'); ?>
                ...
                <div class="col-md-3 col-sm-12">
                  <button type="submit" class="btn btn-default"><i class="fas fa-filter"></i> Filter</a>
                </div>
              </div>
            </form>
            <hr>
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php foreach ($daftar_mahasiswa as $mahasiswa) { ?> <tr>
